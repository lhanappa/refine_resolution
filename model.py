...
def make_generator_model(len_low_size=16, scale=4):
    ...
    Decl = tf.keras.layers.Conv2D(16, [1, 3], strides=(1,2), padding='valid', data_format="channels_last", 
                                    activation='relu', use_bias=False,
                                    kernel_constraint=tf.keras.constraints.NonNeg(), 
                                    kernel_initializer=tf.keras.initializers.RandomNormal(mean=0.01, stddev=0.1), 
                                    name='dec_low_1')(In)
    Decl = tf.keras.layers.Conv2D(128, [1, 3], strides=(1,2), padding='valid', data_format="channels_last", 
                                    activation='relu', use_bias=False,
                                    kernel_constraint=tf.keras.constraints.NonNeg(), 
                                    kernel_initializer=tf.keras.initializers.RandomNormal(mean=0.01, stddev=0.1), 
                                    name='dec_low_2')(Decl)
    Decl = tf.keras.layers.Conv2D(128, [1, 3], strides=(1,2), padding='valid', data_format="channels_last", 
                                    ...
                                    kernel_initializer=tf.keras.initializers.RandomNormal(mean=0.01, stddev=0.1), 
                                    name='dec_low_3')(Decl)
    Decl = tf.keras.layers.Conv2D(512, [1, 3], strides=(1,2), padding='valid', data_format="channels_last", 
                                    activation='relu', use_bias=False,
                                    kernel_constraint=tf.keras.constraints.NonNeg(), 
                                    kernel_initializer=tf.keras.initializers.RandomNormal(mean=0.01, stddev=0.1), 
                                    name='dec_low_4')(Decl)
    ...
    Recl = Reconstruct_R1M(512, name='rec_low')(WeiR1Ml)
    ...
    Rech = Reconstruct_R1M(512, name='rec_high')(WeiR1Ml)
...
def make_discriminator_model(len_low_size=16, scale=4):
    ...
    conv = tf.keras.layers.Conv2D(128, 4, strides=2, padding='valid', kernel_initializer=tf.keras.initializers.RandomNormal(mean=0.01, stddev=0.02), use_bias=True)(inp)
    ...
    conv = tf.keras.layers.Conv2D(256, 2, strides=2, padding='valid', kernel_initializer=tf.keras.initializers.RandomNormal(mean=0.01, stddev=0.02), use_bias=True)(relu)
    #conv = tf.keras.layers.Dropout(0.1)(conv)
    #pool = tf.keras.layers.MaxPooling2D()(conv)
    sym = Symmetry_R1M()(conv)
    batchnorm = tf.keras.layers.BatchNormalization()(sym)
