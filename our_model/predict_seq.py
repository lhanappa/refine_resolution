...
def predict(path='./data',
    ...
    sr_file = raw_file.split('-')[0] + '_' + raw_file.split('-')[1] + '_' + raw_file.split('-')[2] +'-' +str(scale) + '_' + raw_file.split('.')[1]
    ...
    Ml = operations.sampling_hic(Mh, scale, fix_seed=True) # was scale**2
